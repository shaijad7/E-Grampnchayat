	<?php
	...
	//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
		...
		$addcategory = addactivity($activity_name,$activity_detail,$activity_date,$newfilename);
							...
							<div class="box-body">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="activity_name" name="activity_name" required onkeypress="return spacerestri(event, this);">                                
									</div>                               
									<div class="form-group">
										<label>activity_detail.*</label>                                
										<input type="text" class="form-control" id="activity_detail" name="activity_detail" required onkeypress="return spacerestri(event, this);">                                
									</div>                               
									 <div class="form-group">
										<label>activity_date*</label>                                
										<input type="date" class="form-control" id="activity_date" name="activity_date" required onkeypress="return spacerestri(event, this);">                                
									</div>
