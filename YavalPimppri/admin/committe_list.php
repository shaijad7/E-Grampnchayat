...
include 'sidebar.php';
$category_data = array();
$category_data = getAllcommitteData();
?>
<style>
                    ...
                    <div class="box-body" style="overflow-x: scroll;">
                        <table id="categorydata" class="table table-bordered table-striped">
                            <thead>
                                <tr>                                                              
                                    <th>committe_name</th>       
									<th>committe_vord_no</th>
									<th>committe_type</th>
									<th>committe_mo_no</th>
									<th>committe_bdate</th>
									<th>image</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo "<td>" . $val['committe_name'] . "</td>";
										echo "<td>" . $val['committe_vord_no'] . "</td>";
										echo "<td>" . $val['committe_type'] . "</td>";
										echo "<td>" . $val['committe_mo_no'] . "</td>";
										echo "<td>" . $val['committe_bdate'] . "</td>";
                                        ...
                                        echo "> </td>";
                                        echo "<td><a href='edit_committe.php?cid=".$val['iCategoryID']."' role='button' class='btn btn btn-primary editcategory' data-toggle='modal'>Edit</a></td>&nbsp;&nbsp;";//<a href='#deletemodal' id='deletecategory" . $val['iCategoryID'] . "' iCategoryID='" . $val['iCategoryID'] . "' role='button' class='deletecategory btn btn btn-danger' data-toggle='modal'>Remove</a> </td>";
										echo "<td><a href='committedelete.php?catid=".$val['iCategoryID']."' role='button' class='btn btn btn-primary editcategory' data-toggle='modal'>Remove</a></td>&nbsp;&nbsp;";//<a href='#deletemodal' id='deletecategory" . $val['iCategoryID'] . "' iCategoryID='" . $val['iCategoryID'] . "' role='button' class='deletecategory btn btn btn-danger' data-toggle='modal'>Remove</a> </td>";
