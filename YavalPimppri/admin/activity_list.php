...
include 'sidebar.php';
$category_data = array();
$category_data = getAllactivityData();
?>
<style>
                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo "<td>" . $val['activity_name'] . "</td>";
										echo "<td>" . $val['activity_detail'] . "</td>";
										echo "<td>" . $val['activity_date'] . "</td>";
                                        ...
                                        echo "> </td>";
                                        echo "<td><a href='edit_activity.php?cid=".$val['iCategoryID']."' role='button' class='btn btn btn-primary editcategory' data-toggle='modal'>Edit</a></td>&nbsp;&nbsp;";//<a href='#deletemodal' id='deletecategory" . $val['iCategoryID'] . "' iCategoryID='" . $val['iCategoryID'] . "' role='button' class='deletecategory btn btn btn-danger' data-toggle='modal'>Remove</a> </td>";
										echo "<td><a href='activitydelete.php?catid=".$val['iCategoryID']."' role='button' class='btn btn btn-primary editcategory' data-toggle='modal'>Remove</a></td>&nbsp;&nbsp;";//<a href='#deletemodal' id='deletecategory" . $val['iCategoryID'] . "' iCategoryID='" . $val['iCategoryID'] . "' role='button' class='deletecategory btn btn btn-danger' data-toggle='modal'>Remove</a> </td>";
