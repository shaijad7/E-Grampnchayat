...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
    ...
    $addcategory = addminister($minister_name,$minister_category,$newfilename);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Name*</label>                                
                                    <input type="text" class="form-control" id="minister_name" name="minister_name" required onkeypress="return spacerestri(event, this);">                                
                                </div>                               
                                <div class="form-group">
                                    <label>Minister Category.*</label>                                
                                    <input type="text" class="form-control" id="minister_category" name="minister_category" required onkeypress="return spacerestri(event, this);">                                
                                </div>                               
