...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
    ...
    $addcategory = addachievment($achievment_username,$achievment_detail,$achievment_type,$achievment_year,$newfilename);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="achievment_username" name="achievment_username" required onkeypress="return spacerestri(event, this);">                                
                                </div>                               
                                <div class="form-group">
                                    <label>achievment_detail.*</label>                                
                                    <input type="text" class="form-control" id="achievment_detail" name="achievment_detail" required onkeypress="return spacerestri(event, this);">                                
                                </div> 
								<div class="form-group">
                                    <label>achievment_type.*</label>                                
                                    <input type="text" class="form-control" id="achievment_type" name="achievment_type" required onkeypress="return spacerestri(event, this);">                                
                                </div>
                                 <div class="form-group">
                                    <label>achievment_year*</label>                                
                                    <input type="date" class="form-control" id="achievment_year" name="achievment_year" required onkeypress="return spacerestri(event, this);">                                
                                </div>
