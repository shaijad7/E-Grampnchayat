...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
    ...
    $addcategory = addplace($place_name,$place_detail,$place_date,$newfilename);
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="place_date" name="place_date" required onkeypress="return spacerestri(event, this);">                                
                                </div>
