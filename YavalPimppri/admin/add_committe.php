...
if (isset($_POST['submitdata']) && $_POST['submitdata'] == 'Save') {
	...
	$committe_vord_no = $_POST['committe_vord_no'];
	$committe_type = $_POST['committe_type'];
	$committe_mo_no = $_POST['committe_mo_no'];
	$committe_bdate = $_POST['committe_bdate'];
    $fileName = '';
...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
    ...
    $addcategory = addcommitte($committe_name,$committe_vord_no,$committe_type,$committe_mo_no,$committe_bdate,$newfilename);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>committe_name*</label>                                
                                    <input type="text" class="form-control" id="committe_name" name="committe_name" required onkeypress="return spacerestri(event, this);">                                
                                </div>                               
                                <div class="form-group">
                                    <label>committe_vord_no.*</label>                                
                                    <input type="text" class="form-control" id="committe_vord_no" name="committe_vord_no" required onkeypress="return spacerestri(event, this);">                                
                                </div> 
								<div class="form-group">
                                    <label>committe_type.*</label>                                
                                    <input type="text" class="form-control" id="committe_type" name="committe_type" required onkeypress="return spacerestri(event, this);">                                
                                </div>
                                 <div class="form-group">
                                    <label>committe_mo_no*</label>                                
                                    <input type="text" class="form-control" id="committe_mo_no" name="committe_mo_no" required onkeypress="return spacerestri(event, this);">                                
                                </div>
								<div class="form-group">
                                    <label>committe_bdate*</label>                                
                                    <input type="date" class="form-control" id="committe_bdate" name="committe_bdate" required onkeypress="return spacerestri(event, this);">                                
                                </div>
