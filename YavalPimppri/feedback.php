...
<body>
    <form method="post" action="mailto: shaijadshoukatshaikh313@gmail.com" id="form1" class="register-form">
                        ...
                        <div class="row">
                            <div class="col-md-9 contact-form">
                                ...
                                <div class="col-md-12 outer-bottom-small">
                                    <p style="color:red;">टीप :- तुमचे मत फक्त गाव आणि गावाच्या विकासासाठी असावे.</p>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="info-title">नाव <span>*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="info-title">मोबाईल नंबर <span>*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="info-title">गाव/शहराचे नाव<span>*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="info-title" for="exampleInputComments">मत <span>*</span></label>
...
<!-- Mirrored from www.jepurpxzanchayat.com/feedback.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 May 2018 10:45:47 GMT -->
</html>
