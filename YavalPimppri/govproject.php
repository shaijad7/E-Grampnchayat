                    ...
                    <div class="blog-page">
                        <div class="col-md-9">
                                    ...
                                    <div class="blog-post wow fadeInUp">
                                        <h1><a href="javascript:void(0);">विविध शेती योजना</a></h1>
										<?php
												if (!empty($valid_data)) {
										foreach ($valid_data as $val) {
														?>
                                        <span class="date-time"><?php echo $val['valid_start']; ?> पासून <?php echo $val['valid_end']; ?></span>
										<?php
												}
								}
								?>
								<?php
										...
										foreach ($valid_data as $val) {
														?>
                                        <p>वर्ष : 2024-25 साठी विविध कृषी योजनांसाठी ऑनलाइन अर्ज करण्याची तारीख <b><?php echo $val['valid_start']; ?> पासून <?php echo $val['valid_end']; ?></b> पर्यंत <a href='https://www.krishi.maharashtra.gov.in/' target='_blank'>शेती</a>
                                        (आय फार्मर पोर्टल) उघडण्यात आले आहे. त्यामुळे जेपूर गावातील शेतकरी बांधवांनी अर्ज करण्यासाठी पंचायत VCE (संगणक ऑपरेटर) यांच्याशी संपर्क साधावा.<br/><br/><?php
												}
								}
								?>

<b>अर्ज करण्यासाठी आवश्यक कागदपत्रे</b> <br/><br/>
<?php
...
<?php
								...
								?>
<b>विशेष सूचना:</b>अर्ज करून ग्रामसेवक असताना द्यावा<br/><br/>
