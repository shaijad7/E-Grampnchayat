            ...
            <div class="container">
                <div class="row">
                    <div id="UpdatePanel1">
                            ...
                            <div class="col-md-12">
                            <h2 class="heading-title">रक्त गट माहिती</h2>
                                 <span class="title-tag inner-top-ss" style="color: red;">टीप :- येथे नमूद केलेले मूल्यांकन तपशील केवळ तुमच्या माहितीसाठी आहे आणि अधिकृत प्रत म्हणून ग्राह्य धरले जाणार नाही. या तपशिलासंदर्भात कोणत्याही अतिरिक्त माहितीसाठी, ग्रामपंचायत कार्यालयाशी संपर्क साधा. </span>
                                    ...
                                    <div class="shopping-cart-table ">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th class="cart-description item"> नाव</th>
                                                        <th class="cart-qty item">लिंग</th>
                                                        <th class="cart-product-name item">वार्ड क्रमांक</th>
                                                        <th class="cart-edit item">संपर्क क्रमांक</th>
                                                         <th class="cart-qty item">जन्मतारीख</th>
                                                         <th class="cart-qty item">पद</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php
